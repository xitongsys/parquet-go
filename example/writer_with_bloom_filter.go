...
type Student struct {
	Name    string  `parquet:"name=name, type=BYTE_ARRAY, convertedtype=UTF8, encoding=PLAIN_DICTIONARY, bloomfilter=true, bloomfilteritems=1000000, bloomfilterfalsepositiverate=0.01"`
