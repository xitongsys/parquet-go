...
```
Using this interface, parquet-go can read/write parquet file on different platforms. Currently the local interface is implemented. (It's not possible for S3, because it doesn't support random access.)
